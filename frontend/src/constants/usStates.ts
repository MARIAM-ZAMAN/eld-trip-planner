const STATE_COORDINATES = {
  ...
  VT: [44.045876, -72.710686], VA: [37.769337, -78.169968], WA: [47.400902, -121.490494], WV: [38.491226, -80.954456],
...
].map(([name, code]) => ({ name, code, label: `${name}, ${code}`, latitude: STATE_COORDINATES[code][0], longitude: STATE_COORDINATES[code][1] }));